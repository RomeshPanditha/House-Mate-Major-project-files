...
-- -----------------------------------------------------
-- -----------------------------------------------------
-- Schema romeshco_housemate
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `romeshco_housemate` DEFAULT CHARACTER SET utf8 ;
USE `romeshco_housemate` ;

-- -----------------------------------------------------
-- Table `romeshco_housemate`.`house`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`house` (
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`chores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`chores` (
  ...
  CONSTRAINT `chore_to_house`
    ...
    REFERENCES `romeshco_housemate`.`house` (`PK_houseID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 38
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`my_aspnet_membership`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`my_aspnet_membership` (
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`tenant`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`tenant` (
  ...
  CONSTRAINT `memberConstraint`
    ...
    REFERENCES `romeshco_housemate`.`my_aspnet_membership` (`userId`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`chore_allocation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`chore_allocation` (
  ...
  CONSTRAINT `allocation_to_chore`
    ...
    REFERENCES `romeshco_housemate`.`chores` (`PK_choreID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `allocation_to_tenant`
    FOREIGN KEY (`FK_tenantID`)
    REFERENCES `romeshco_housemate`.`tenant` (`PK_tenantID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 24
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`house_bill`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`house_bill` (
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`individual_bills`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`individual_bills` (
  ...
  CONSTRAINT `individual_bill_constraint`
    ...
    REFERENCES `romeshco_housemate`.`house_bill` (`PK_houseBillID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`list`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`list` (
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`item`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`item` (
  ...
  CONSTRAINT `item to list`
    ...
    REFERENCES `romeshco_housemate`.`list` (`PK_listID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 165
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`itemDescriptions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`itemDescriptions` (
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`list_records`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`list_records` (
  ...
  CONSTRAINT `item_to_record`
    ...
    REFERENCES `romeshco_housemate`.`item` (`PK_itemID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`my_aspnet_applications`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`my_aspnet_applications` (
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`my_aspnet_profiles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`my_aspnet_profiles` (
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`my_aspnet_roles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`my_aspnet_roles` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`my_aspnet_schemaversion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`my_aspnet_schemaversion` (
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`my_aspnet_sessioncleanup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`my_aspnet_sessioncleanup` (
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`my_aspnet_sessions`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`my_aspnet_sessions` (
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`my_aspnet_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`my_aspnet_users` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `applicationId` INT(11) NOT NULL,
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`my_aspnet_usersinroles`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`my_aspnet_usersinroles` (
  `userId` INT(11) NOT NULL DEFAULT '0',
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`notice_board`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`notice_board` (
...
-- -----------------------------------------------------
-- Table `romeshco_housemate`.`notice`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `romeshco_housemate`.`notice` (
  ...
  CONSTRAINT `notice_constraint`
    ...
    REFERENCES `romeshco_housemate`.`notice_board` (`PK_noticeBoardID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
